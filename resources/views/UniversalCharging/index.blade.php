...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-12">
            <table style="width: 100%; border-color: black">
                ...
                <tr>
                    <td colspan="2">
                        <button id="UniChargeAddCharge" data-target="#UniChargeAddCharge" class="btn btn-info"><i class="fa fa-file"></i> <span>ADD CHARGE</span></button>
                    </td>
                </tr>
            </table>
    ...
    {{-- MODAL --}}
    <div class="modal fade" id="AddCharge" tabindex="-1" role="dialog" aria-labelledby="AddChargeTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="AddChargeTitle">Add Charge</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
